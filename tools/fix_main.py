...
old = """      final langs = (await tts.getLanguages()).map((e) => e.toString().toLowerCase()).toList();
      String lang = 'ar-SY';
...
if 'class AiFriendPage extends StatefulWidget' not in s:
    marker = 'class RewardsPage extends StatefulWidget'
    ai = '''class AiFriendPage extends StatefulWidget {
